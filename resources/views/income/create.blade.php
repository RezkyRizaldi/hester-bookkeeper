...
@section('title', 'Tambah Data Pemasukan - ' . config('app.name'))
@section('content')
					...
					<div class="form-row">
						<div class="form-group col-md-6">
							...
							<select name="store_id" id="store_id" class="form-control is_select2 @error('store_id') is-invalid @enderror">
								<option selected disabled value="">Pilih Toko</option>
					...
					<div class="form-row">
						<div class="form-group col-md-6">
							...
							<div class="input-group mb-3">
								...
								<input type="text" name="amount" class="form-control format-currency @error('amount') is-invalid @enderror" id="amount" placeholder="Uang Masuk" value="{{ old('amount') }}" maxlength="10" />
								@error('amount')
									<div class="invalid-feedback">
										{{ $message }}
									</div>
